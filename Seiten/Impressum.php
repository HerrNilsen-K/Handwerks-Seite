...
<body>
    <header>
		...
		<article>
			...
			<div class = "Ges-Angaben">
		
				<h3>Angaben gemäß § 5 TMG</h3>
			
				<br />
		
				<div ID="Verantwortlich">
					<strong>Verantwortlich:</strong>
					<br />
					<p>
						Schornsteinfeger GmbH & Co. KG<br />
						Holterhöfchen 34<br />
						40724 Hliden
					</p>
				</div>
				...
				<div ID="Kontakt">
					...
					<br />
					<p>
						Email: Schornsteinfeger-Hilden@info.de 
						Tel.: 02103/800666
					</p>
				</div>
				...
				<div ID="Umsatzsteuer-/Wirtschafts-ID">
					<strong>Umsatzsteuer-ID:</strong>
					<br />
					<p>
						Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz:
						USt.ID-Nr.: DE314159265
					</p>
					...
					<br />
					<p>
						Wirtschafts-Identifikationsnummer gemäß §139c:
						W-ID-Nr.: DE358979323
					</p>
				</div>
			...
			<div ID="Haftungsausschluss">
				...
				<p>
					...
					Datenschutz > Einstellung''; im Firefox unter ''Extras > Einstellungen > Datenschutz > Cookies'');
